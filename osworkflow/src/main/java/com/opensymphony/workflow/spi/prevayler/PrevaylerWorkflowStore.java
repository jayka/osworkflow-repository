 ...
 * See http://www.prevayler.org/wiki.jsp
 *
 * It creates a transient or non-transient store depending upon the properties set.
 *
...
public class PrevaylerWorkflowStore implements WorkflowStore, Serializable {
    ...
    /* (non-Javadoc)
     * @see com.opensymphony.workflow.spi.WorkflowStore#createCurrentStep(long, int, java.lang.String, java.util.Date, java.util.Date, java.lang.String, long[])
     */
    ...
    /* (non-Javadoc)
     * @see com.opensymphony.workflow.spi.WorkflowStore#createEntry(java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see com.opensymphony.workflow.spi.WorkflowStore#markFinished(com.opensymphony.workflow.spi.Step, int, java.util.Date, java.lang.String, java.lang.String)
     */
    ...
    /* (non-Javadoc)
     * @see com.opensymphony.workflow.spi.WorkflowStore#moveToHistory(com.opensymphony.workflow.spi.Step)
     */
    ...
    /* (non-Javadoc)
     * @see com.opensymphony.workflow.spi.WorkflowStore#query(com.opensymphony.workflow.query.WorkflowQuery)
     */
     ...
     */
    private void initializePrevaylenceSystem(String prevalenceBase, boolean isTransient) throws IOException, ClassNotFoundException, Exception {
        if (isTransient) {
